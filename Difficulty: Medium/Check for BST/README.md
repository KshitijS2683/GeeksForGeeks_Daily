<h2><a href="https://www.geeksforgeeks.org/problems/check-for-bst/1?page=2&category=Tree&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Check for BST</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given the <strong>root</strong> of a binary tree. Check whether it is a BST or not.<br></span></p>
